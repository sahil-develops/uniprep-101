...
export default function AboutSingapore() {
  return (
    <section className="bg-[#F7F3E3] py-5 sm:py-20">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center gap-4 lg:gap-12 px-4 sm:px-6 lg:flex-row lg:items-start">
        <div className="w-full flex-1 text-center lg:text-left">
          <h2 className="text-balance lg:text-center text-left text-2xl font-bold text-[#0A1431] sm:text-4xl lg:text-5xl">
            Why Singapore
          </h2>
          <p className="mt-2 lg:mt-6 text-[15px] lg:leading-7 text-[#25345A] sm:text-lg text-left">
          ...
          <p className="lg:mt-4 mt-2 text-[15px] lg:leading-7 text-[#25345A] sm:text-lg text-left">
