...
function TeamMemberCard({ member }: { member: TeamMember }) {
  ...
  return (
    ...
    >
      <div className="flex h-32 w-28 shrink-0 items-center justify-center overflow-hidden rounded-full border-4 border-white bg-[#E6EEF9] shadow-lg sm:h-32 sm:w-32">
        {member.imageSrc ? (
          <Image
            src={member.imageSrc}
            alt={member.name}
